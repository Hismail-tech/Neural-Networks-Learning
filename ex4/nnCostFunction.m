...
% Part 1: CostFunction
% -------------------------------------------------------------
% where X is for all the training samples presented to the network ones 
% you have to conceptually transpose them
a1 = X; % X is 5000 by 401 then transpose conceptually to represent indi training expample
z2 = a1*Theta1'; % z2 is 5000 by 10 then trasn........
a2 = sigmoid(z2); % a2 is 5000 by 10 then trasn........
a2 = [ones(m , 1)  a2]; % a2 becomes 5000 by 11 then trasn........
a3 = sigmoid(a2*Theta2'); % a3 is 5000 by 10 then ......
...
delta3 = a3 - ry;
z = delta3*Theta2;
delta2 = z(:,2:end) .* sigmoidGradient(z2);
